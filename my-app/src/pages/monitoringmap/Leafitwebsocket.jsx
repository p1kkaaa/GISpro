...
function MonitoringL() {
  ...
  // Пример WebSocket или API для получения данных
  useEffect(() => {
    // Здесь можно подключить WebSocket или использовать API для получения координат в реальном времени
    const interval = setInterval(() => {
      // Пример получения новых данных о местоположении (например, от сервера)
      const newLatLng = [
